...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='TestAttemptModular',
            fields=[
                ('testattempt_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='study_base.testattempt')),
                ('test', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='study_base.plannedtestmodular', verbose_name='Test')),
            ],
            bases=('study_base.testattempt',),
        ),
        migrations.CreateModel(
            name='TestAttemptManual',
            fields=[
                ('testattempt_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='study_base.testattempt')),
                ('test', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='study_base.plannedtestmanual', verbose_name='Test')),
            ],
            bases=('study_base.testattempt',),
        ),
    ]
